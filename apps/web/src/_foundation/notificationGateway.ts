...
export interface NotificationGateway {
  notify(type: NotificationType, location: Location, book: BookMetadata): Promise<void>
}

export class MockNotificationGateway implements NotificationGateway {
  notify(_type: NotificationType, _location: Location, _book: BookMetadata): Promise<void> {
